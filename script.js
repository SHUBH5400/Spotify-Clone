...
let songs = [
    ...
    {songName: "Beetain Lamhe", filePath:"songs/2.mp3", coverPath:"covers/2.jpg"},
    {songName: "Chahun Main Ya Na", filePath:"songs/3.mp3", coverPath:"covers/3.jpg"},
    ...
    {songName: "Mann Meri Jann", filePath:"songs/7.mp3", coverPath:"covers/7.jpg"},
    {songName: "Malang Sajna", filePath:"songs/8.mp3", coverPath:"covers/8.jpg"},
    {songName: "O Meri", filePath:"songs/9.mp3", coverPath:"covers/9.jpg"},
    {songName: "Rataan Lambiyaan", filePath:"songs/10.mp3", coverPath:"covers/10.jpg"},
]
...
audioElement.addEventListener('timeupdate',() =>{
    //  console.log('timeupdate');  //we got timeupdate in console by this

    //update seekbar
    progress = parseInt((audioElement.currentTime/audioElement.duration)*100);
    // console.log(progress);  // we got progress percentage by this
